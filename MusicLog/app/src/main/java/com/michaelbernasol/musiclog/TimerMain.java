    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input.length() == 0){
                    Toast.makeText(TimerMain.this, "Field can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                long milliInput = Long.parseLong(input) * 60000;
                if(milliInput == 0){
                    Toast.makeText(TimerMain.this, "Please Enter a Positive Number", Toast.LENGTH_SHORT).show();
                    return;
                }
                setTime(milliInput);
